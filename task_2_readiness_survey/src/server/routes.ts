...
function calculateCategoryScores(responses: Record<string, number | string>): Record<string, number> {
  ...
  const categoryQuestions: Record<string, string[]> = {
    'strategy_governance': ['sg_digital_strategy', 'sg_ethical_policies', 'sg_budget_allocation', 'sg_leadership_perception'],
    'data_tech_infrastructure': ['dti_data_quality', 'dti_tech_tools', 'dti_staff_access', 'dti_systems_integration'],
    'people_skills': ['ps_data_literacy', 'ps_training_programs', 'ps_designated_team', 'ps_innovation_culture', 'ps_capacity_building'],
    'process_data_practices': ['pdp_workflow_digitization', 'pdp_data_driven_decisions', 'pdp_process_standardization'],
    'ai_applications_risks': ['aar_ai_implementation', 'aar_ai_scale', 'aar_ai_ethics', 'aar_ai_awareness', 'aar_ai_future']
  };
