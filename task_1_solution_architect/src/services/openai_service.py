...
Should you ask another question or do you have sufficient information for comprehensive recommendations?"""
    ...
    def generate_comprehensive_solution(problem_statement, answers):
        ...
        try:
            ...
            system_prompt = """You are a senior nonprofit technology strategist creating a comprehensive solution based on detailed interactive questioning. Design a sophisticated, multi-layered technology strategy that addresses ethical considerations critical to nonprofit operations.

Respond with JSON in this format:
{
    "analysis_summary": "Deep analysis of root causes and strategic context (3-4 sentences)",
    "solution_summary": "Comprehensive strategic overview with implementation phases (3-4 sentences)",
...
Create a sophisticated solution addressing immediate needs and long-term transformation. Consider all constraints and opportunities revealed through questioning.
